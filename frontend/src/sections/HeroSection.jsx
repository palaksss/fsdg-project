        ...
        <div className="flex flex-col items-center justify-center text-center bg-[url('/assets/hero-section-dot-image.png')] bg-cover bg-no-repeat">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>AI-Powered ATS Resume Analyzer</span>
            ...
            <p className="text-base text-slate-600 max-w-lg mt-5">Analyze your resume against job descriptions, discover missing skills, improve your ATS score, and receive AI-powered suggestions instantly.</p>
